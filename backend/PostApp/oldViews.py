...
def upload_image(request):
    ...
    upload = ImageSet.objects.create(name=name, location=image)
    return Response({"message": "Uploaded successfully!", "imageName": upload.imageName, "imageLocation": upload.imageLocation.url})
